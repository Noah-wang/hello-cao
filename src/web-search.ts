...
const SEARCH_TRIGGER = /(?:搜索|搜一下|查一下|查查|最新|今天|今日|现在|目前|实时|近期|新闻|价格|多少钱|汇率|天气|比分|赛程|发布了吗|官网|纪录|记录是多少|世界纪录|全国纪录|美国纪录|什么时候(?:开始|举行|报名)|何时(?:开始|举行|报名)|(?:比赛|赛事|马拉松|越野赛).*(?:时间|日期|开始|报名)|(?:桑拿|疾病|症状|药物|用药|治疗|体检|血压|血糖|心率|健康).*(?:好处|坏处|作用|风险|怎么办|怎么做|是否|能不能))/iu;
